...
interface BurnStatsContainerProps {
  statsSupplies: any; // Replace with the actual type of statsSupplies
  walletChain: any; // Replace with the actual type of walletChain
  suppliesChain: any; // Replace with the actual type of suppliesChain
  tokenAddress: string;
  openChainModal: () => void;
}
